...
dat_scaled = dat_join[complete.cases(dat_join),]
```

```{r model}

dat_test = dat_scaled[,c(1:5,8)]
names(dat_test) = c("block", "PlantHeight","LeafWeight","TotalWeight","TRL","NumTips")
dat_test = filter(dat_test, block == "C")


dat_test = mutate_if(dat_test, is.numeric, scale)
